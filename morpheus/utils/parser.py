...
def _common_parser():
    ...
    parser.add_argument("--project", type=str, default="morpheus-fs-media", help="Project for wandb logging")
    parser.add_argument("--seed", type=int, default=1999, help="Seed for reproducibility")
    parser.add_argument("--epochs_pretrained", type=int, default=200, help="Number of epochs for pretraining")
